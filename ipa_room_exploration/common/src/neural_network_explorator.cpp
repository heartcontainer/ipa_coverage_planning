...
void NeuralNetworkExplorator::getExplorationPath(const cv::Mat& room_map, std::vector<geometry_msgs::msg::Pose2D>& path, const float map_resolution,
...
//		geometry_msgs::msg::Pose2D current_point = fov_path[point_index];
//		geometry_msgs::msg::Pose2D next_point = fov_path[(point_index+1)%(fov_path.size())];
//
